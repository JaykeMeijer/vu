...
Inserting and deleting will be done by going through the list locking 2
elements at the time.  After finding the right element pointers will be set and
locks freed. Figure \ref{fig:fine_insert} shows an example of how an insertion
would be executed.
...
item 100 in the list another thread Y can lock all elements 1 to 99. This
allows thread y to operate on those elements.
